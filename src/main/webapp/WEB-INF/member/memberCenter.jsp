                ...
                <div id="allItem">
                    ...
                    <div class="items">
                        <div class="headphotobox">
                            <div class="headphoto">
                                <img src="/images/member/member.png" alt="Product" style="width:100%">
                            </div>
                        </div>

                        <div class="memberInfo">
                            <div id="verify">
                                <input type="button" class="btn sendMail" value="發送驗證信">
                                <a title="會員資料已認證" href="/" class="">信箱尚未認證!</a>
                    ...
                    <!-- 專案資訊 area 開始 -->
                    <p class="likehr">text with like hr, legend</p>
                    <div class="items">


                        <div class="memberInfo">
                            <div class="memberDetail1">
                                <div>您好，<a title="會員資料已認證" href="/" class="">會員資料已認證!</a>

                                    <a href="" class=" ">
                                        <span class="">等級無</span>
                                        <ul id="energetic_lv" style="display:none;">
                                            <li class="triangle an01"></li>
                                            <li class="triangle an02"></li>
                                            <li class="count">本日累積：<i>+5</i></li>
                                            <li class="count">累積分數：<b>60</b></li>
                                        </ul>
                                    </a>
                                </div>

                            </div>
                            <div id="msgrecord" class="memberDetail">
                                <ul>
                                    <li class="noborder">我的詢問：<button>0筆新訊息</button></li>
                                    <li>成交案件：<a href="">0筆新成交</a></li>
                                </ul>
                            </div>
                            <div id="msgrecord" class="memberDetail">
                                帳戶餘額：<span>0</span>元 <a href="">明細</a>
                                <ul>
                                    <li><a href="">付款方式</a></li>
                                    <li><a href="">我要提款</a></li>
                                    <ul>
            ...
            function initInviteFriendList(friendList) {
                friendList.forEach(friend => {
                    ...
                    inviteFriendstr = '<div class="inviteFriend">'
                        ...
                        + '<button class="btn friendConfirmBtn">拒絕</button>'
                        + '</div>';

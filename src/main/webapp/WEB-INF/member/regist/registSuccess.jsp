...
<!-- Title  -->
<title>UniversalHosue - Furniture Ecommerce Template | Regist</title>
	...
	<div class="main-content-wrapper d-flex clearfix">
		...
		<header class="header-area clearfix">
			...
			<div class="amado-btn-group mt-30 mb-100">
				<a href="<c:url value='/index.jsp' />" class="btn amado-btn mb-15">%Discount%</a>
				<a href="<c:url value='/member/login/login.jsp' />"
					class="btn amado-btn active">Login</a>
			</div>
			<!-- Cart Menu -->
			<div class="cart-fav-search mb-100">
				<a href="<c:url value='/index.jsp' />" class="cart-nav"><img
						...
						<div class="checkout_details_area mt-50 clearfix">
							...
							<div class="cart-title" style="text-align: center;">
								...
								<div class="success-message">
									...
									<p>
										You will be redirected to the Loginpage in <span id="countdown">5</span>
										seconds...
									</p>
								</div>
							</div>

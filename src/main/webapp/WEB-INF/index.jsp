			...
			<div class="products-catagories-area clearfix">
				<div class="amado-pro-catagory clearfix">
					...
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/1.jpg" alt="">
							<!-- Hover Content -->
					...
					<!-- Single Catagory -->
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/2.jpg" alt="">
							<!-- Hover Content -->
							<div class="hover-content">
								<div class="line"></div>
								<p>From $180</p>
					...
					<!-- Single Catagory -->
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/3.jpg" alt="">
							<!-- Hover Content -->
							<div class="hover-content">
								<div class="line"></div>
								<p>From $180</p>
					...
					<!-- Single Catagory -->
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/4.jpg" alt="">
							<!-- Hover Content -->
							<div class="hover-content">
								<div class="line"></div>
								<p>From $180</p>
					...
					<!-- Single Catagory -->
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/5.jpg" alt="">
							<!-- Hover Content -->
							<div class="hover-content">
								<div class="line"></div>
								<p>From $18</p>
					...
					<!-- Single Catagory -->
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/6.jpg" alt="">
							<!-- Hover Content -->
							<div class="hover-content">
								<div class="line"></div>
								<p>From $320</p>
					...
					<!-- Single Catagory -->
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/7.jpg" alt="">
							<!-- Hover Content -->
							<div class="hover-content">
								<div class="line"></div>
								<p>From $318</p>
					...
					<!-- Single Catagory -->
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/8.jpg" alt="">
							<!-- Hover Content -->
							<div class="hover-content">
								<div class="line"></div>
								<p>From $318</p>
					...
					<!-- Single Catagory -->
					<div class="single-products-catagory clearfix">
						<a href="shop.html"> <img src="/amado-master/img/bg-img/9.jpg" alt="">
							<!-- Hover Content -->
							<div class="hover-content">
								<div class="line"></div>
								<p>From $318</p>

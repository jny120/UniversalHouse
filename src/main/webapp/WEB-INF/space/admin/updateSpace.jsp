...
<!--                                     <label for="pic"> </label> -->
                                    Update Picture
<%--                                     <img src="<c:url value='spaceShowImg.controller?spaceNo=${update.spaceNo}' />" alt="無原始圖片"  width="400px" height="280px"> --%>
                                   				...
                                   				<c:choose>
					                                ...
					                                <c:when test="${update.pic.length() != 0}">
														<img src="spaceShowImg.controller?spaceNo=${update.spaceNo}" width="200px" height="140px">
					                                </c:when>
					                        	</c:choose>
